            ...
            <ul class="nav navbar-nav">
               ...
               <li class="dropdown">
                   ...
                   @else
                      ...
                      @endphp
                   @endif
                   <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-globe"></i><span>{{ $language }}</span></a>
                   <ul class="dropdown-menu">
                      <li><a href="locale/vi"><span><i class="flag-icon flag-icon-vn"></i><span> Vietnamese</span></span></a></li>
                      <li><a href="locale/en"><span><i class="flag-icon flag-icon-us"></i><span> English</span></span></a></li>
                   </ul>
                </li>
               ...
               <li class="dropdown">
                    {{-- {!! Form::open(['method' => 'POST', 'url'=>'language']) !!}
                        {!! Form::select
                            (
                                'locale',
                                ['en' => 'English',
