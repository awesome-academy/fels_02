                ...
                <div class="col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            ...
                            {!! Form::open(['method'=>'POST', 'enctype'=>'multipart/form-data', 'class'=>'form-horizontal', 'route'=>'user.store']) !!}
                            <div class="row form-group">
                                <div class="col col-md-3">
                                    {!! Form::label('text-input', trans('adminMess.lb_username'), ['class'=>'form-control-label']) !!}
                                </div>
                                <div class="col-12 col-md-9">
                                    {!! Form::text('username', old('username'), ['id'=>'text-input', 'placeholder'=>trans('adminMess.place_username'), 'class'=>'form-control']) !!}
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    {!! Form::text('fullname', old('fullname'), ['placeholder'=>trans('adminMess.place_fullname'), 'class'=>'form-control']) !!}
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3">
                                ...
                                <div class="col-12 col-md-9">
                                    {!! Form::email('email', old('email'), ['placeholder'=>trans('adminMess.place_email'), 'class'=>'form-control']) !!}
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <div class="input-group">
                                       ...
                                       {!! Form::text('birthday', '', ['id'=>'date', 'class'=>'form-control', 'placeholder'=>'YYYY/DD/MM']) !!}
                                    </div>
                                </div>
                            </div>
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    {!! Form::text('address', old('address'), ['placeholder'=>trans('adminMess.place_address'), 'class'=>'form-control']) !!}
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3">
                                ...
                                <div class="col-12 col-md-9">
                                    {!! Form::text('phone', old('phone'), ['placeholder'=>trans('adminMess.place_phone'), 'class'=>'form-control']) !!}
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3">
